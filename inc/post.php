...
function admin_save_page_edits() {
    ...
    update_option('mc_home_map_text', $home_map_text);
    update_option('mc_chi_siamo_main_img', $chi_siamo_main_img);
    update_option('mc_chi_siamo_title_1', $chi_siamo_title_1);
    update_option('mc_chi_siamo_text_1', $chi_siamo_text_1);
    update_option('mc_chi_siamo_img_1', $chi_siamo_img_1);
    update_option('mc_chi_siamo_title_2', $chi_siamo_title_2);
    update_option('mc_chi_siamo_text_2', $chi_siamo_text_2);
    update_option('mc_chi_siamo_img_2', $chi_siamo_img_2);
    update_option('mc_chi_siamo_content_1', $chi_siamo_content_1);
    update_option('mc_chi_siamo_content_2', $chi_siamo_content_2);
    update_option('mc_contatti_main_img', $contatti_main_img);
    update_option('mc_contacts_phone', $contacts_phone);
    update_option('mc_contacts_whatsapp', $contacts_whatsapp);
    update_option('mc_contacts_email', $contacts_email);
