            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="d-flex w-100 mb-3">
                            <div class="w-50">
                                <input type="text" name="rag_sociale" class="form-control" form="form-promo" placeholder="Ragione Sociale *" required>
                            </div>
                            <div class="w-50">
                                <input type="text" name="piva" class="form-control" form="form-promo" placeholder="Partita IVA *" required>
                            </div>
                        </div>
                        ...
                        <label for="privacy-check"><input type="checkbox" class="form-check-input me-2" form="form-promo" required>Acconsento alla condivisione dei miei dati per essere ricontattato da Megacarta S.r.l. e alla loro memorizzazione per facilitare la fruizione del servizio. Dichiaro di essere maggiorenne, di aver letto e accettato <a href="/condizioni-duso">Condizioni d'uso</a> e <a href="/privacy-policy">Privacy Policy</a></label>
